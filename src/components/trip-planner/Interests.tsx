...
import { Search, ArrowLeft, Compass, X } from "lucide-react"
    ...
    return (
        ...
        <div className="flex h-screen w-full">
                ...
                <div className="flex-1 space-y-4 overflow-y-auto py-8 my-8 border-t border-b border-border">
                    {selectedInterests.length > 0 ? (
                        ...
                        <div className="flex items-center justify-center h-full">
                            <p className="text-muted-foreground text-center">Select interests from the right to get started.</p>
                        </div>
                    )}
                </div>
            ...
            <div className="w-full md:w-2/3 h-screen flex flex-col p-8 lg:p-12 bg-card">
                ...
                <div className="flex-1 overflow-y-auto my-8 py-4 pr-2"> {/* pr-2 for scrollbar spacing */}
                ...
                <div className="flex w-full max-w-xl mx-auto gap-2 pt-6 border-t border-border">
                     <Input
                        ...
                        className="h-12"
                    />
                    <Button onClick={handleAddCustomInterest} className="h-12 px-6">
                        Add
                    </Button>
                </div>
            </div>
